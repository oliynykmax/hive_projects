...
| ---------------------------------------------------- | --------------- | --------------------------------------------------------------------------- | ---------------- |
| 📚      | [`libft`](https://github.com/oliynykmax/libft_max)            | Utility functions library                                                   | 125              |
| 🖨️     | [`ft_printf`](https://github.com/oliynykmax/ft_printf)    | Variadic function for printing string templates with value conversions      | 100              |
...
|  🧠        | [`philosophers`](https://github.com/oliynykmax/philo)         | Project on the classic Dining Philosophers problem, involving the use of POSIX threads, mutexes, and atomic types.           | 100 <br/>
...
|                                                   | Name         | Description                                              |
| ------------------------------------------------------- | ------------ | -------------------------------------------------------- |
| 👶 | [`piscine`](https://github.com/oliynykmax/Piscine42)    | All the code written during Hive Helsinki pool - 1 month of intensive studies which determined if students got in        |
